...
I did spin up my own [[https://social.baty.net][Mastodon instance]]. I'm still not sure why. I love that my username is @jack@baty.net, though. The problem with self-hosting something like this is I need to commit to it /forever/ and that's a long time.
