...
:PROPERTIES:
:EXPORT_FILE_NAME: 2022-07-28-Thursday
...
@@html: {{< image src="2022-Roll-66_05.jpg" caption="Alice, 2022. Leica MP, 35mm Summilux, Tri-X" >}}@@
...
This site is created with [[https://gohugo.io][Hugo]] using a variation of the [[https://github.com/dillonzq/LoveIt][LoveIt]] theme. Posts are written in [[https://orgmode.org][Org mode]] and exported to Markdown using [[https://ox-hugo.scripter.co][ox-hugo]]. ([[/changelog][Changelog]])
